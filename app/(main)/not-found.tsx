...
export default function NotFound() {
  return (
    <main className="flex h-screen w-full flex-col items-center justify-center bg-[#1A2238]">
      ...
      <div className="absolute rotate-12 rounded bg-black p-1 px-2 text-sm text-white">
        Page Not Found
      </div>
      <button className="mt-5">
        <Link
          href="/"
          className="group relative inline-block text-sm font-medium text-white hover:text-gray-300 focus:outline-none focus:ring active:text-white"
        >
